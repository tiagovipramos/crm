...
async function corrigirVendasFantasma() {
  ...
  console.log('');
  console.log('================================================');
  console.log('🔧 CORRIGINDO VENDAS FANTASMA');
  console.log('================================================');
  console.log('');
  ...
  try {
    ...
    // Buscar indicações "converteu" com leads que NÃO estão convertidos
    ...
    console.log(`📊 Encontradas ${indicacoesErradas.length} vendas fantasma`);
    console.log('');
    ...
    for (const row of indicacoesErradas) {
      ...
      if (row.lead_status === 'proposta_enviada') {
    ...
    await connection.execute(
      ...
      [indicador.id, '🔧 CORREÇÃO - Vendas fantasma removidas, status sincronizado com CRM']
    );
    ...
    console.log('================================================');
    console.log('');
    console.log(`📊 ${indicacoesErradas.length} vendas fantasma corrigidas`);
...
corrigirVendasFantasma().catch(console.error);
